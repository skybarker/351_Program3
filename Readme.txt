...
Luke and Autumn Barker

No additional packages were added

1. Cutscene Camera.  Should work per requirements.
...
5. Toggle the Camera.  There are two virtual cameras that toggle between the first person and orbit camera using the T key.  We found a code snipped to include a zoom in/out using the scroll button too.  
